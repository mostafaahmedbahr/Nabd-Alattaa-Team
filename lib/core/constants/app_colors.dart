...
class AppColors {
  ...
  static const Color scaffoldBg = Color(0xFFF0EDF5);
  ...
  // Task Status
  static const Color taskNotStarted = Color(0xFF9CA3AF);
  static const Color taskInProgress = Color(0xFF3B82F6);
  static const Color taskInReview = Color(0xFFF59E0B);
  static const Color taskCompleted = Color(0xFF10B981);
  static const Color taskLate = Color(0xFFEF4444);
